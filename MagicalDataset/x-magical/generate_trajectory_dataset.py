...
"""
from xmagical.style import set_environment, get_environment
set_environment("xmagical")
from absl import app
from absl import flags
from configs.constants import EMBODIMENTS, TASKS, OBSERVATION_SPACE, VIEW_MODE, VARIANT
...
flags.DEFINE_enum("task", "MatchRegions", TASKS,
                  "The agent task.")
...
def main(_):
  ...
  env = utils.make_env(env_name, seed=FLAGS.seed, use_dense_reward=True,config=config)
