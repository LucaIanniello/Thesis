...
def main(_):
    ...
    save_path = "/tmp/xirl/datasets/magical_xirl/match-regions/video"
    save_path_images = "/tmp/xirl/datasets/magical_xirl/match-regions/train/gripper"
    height, width = (384, 384)
    for int_seed in range(*list(map(int, FLAGS.seeds))):
        seed = str(int_seed).zfill(3)
        video_path = f"/tmp/xirl/datasets/magical/match-regions/demo-MatchRegions-Demo-v0-{seed}.pkl.gz"
